...
export const projects = [
    ...
    },
    {
        ...
        description: 'This dashboard was designed to empower Claire with comprehensive, real-time insights into customer service performance, enhancing decision-making and operational efficiency.',
    ...
    },
    {
        ...
        description: 'This dashboard was developed to provide the retention manager with strategic insights into customer loyalty and behavior, guiding targeted actions to enhance retention rates.',
    ...
    },
    {
        ...
        description: 'Analyzing these metrics will allow us to develop targeted KPIs that accurately measure and enhance gender diversity at the executive level, fostering a truly inclusive corporate culture.',
        link: 'https://app.powerbi.com/links/8eIr7CIT_u?ctid=8d1a69ec-03b5-4345-ae21-dad112f5fb4f&pbi_source=linkShare',
    },
    {
        iconUrl: summiz,
        theme: 'btn-back-yellow',
        name: 'Gen AI Chat-Bot',
        description: 'Developed an AI-powered chatbot designed to deliver financial insights and analysis, enhancing user engagement with data-driven recommendations.',
        link: 'https://github.com/jdeora/Gen-AI-ChatBot.git',
    }
];
